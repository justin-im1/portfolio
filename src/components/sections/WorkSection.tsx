    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <div className="w-6 h-6 md:w-10 md:h-10 flex items-center justify-center">
          <span className="text-lg md:text-2xl" role="img" aria-label="marketing">📈</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="w-6 h-6 md:w-10 md:h-10 flex items-center justify-center">
          <span className="text-lg md:text-2xl" role="img" aria-label="hospital">🏥</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="w-6 h-6 md:w-10 md:h-10 flex items-center justify-center">
          <span className="text-lg md:text-2xl" role="img" aria-label="speech bubble">💬</span>
        </div>
      </div>
    </div>
  );
